...
1. **Personal TELOS** - {PRINCIPAL.NAME}'s life context system (beliefs, goals, lessons, wisdom) at `${PAI_DIR}/PAI/USER/TELOS/`
...
|--------------|---------|----------|
| "my TELOS", "my goals", "my beliefs", "add to TELOS" | Personal TELOS | `${PAI_DIR}/PAI/USER/TELOS/` |
...
All files located in `${PAI_DIR}/PAI/USER/TELOS/`:
...
```bash
# View specific file
read ${PAI_DIR}/PAI/USER/TELOS/GOALS.md
read ${PAI_DIR}/PAI/USER/TELOS/BELIEFS.md

# View recent updates
read ${PAI_DIR}/PAI/USER/TELOS/updates.md
```
...
1. **Dual Context** - Handles both personal and project TELOS seamlessly
   - Personal TELOS: `${PAI_DIR}/PAI/USER/TELOS/` (in CORE USER directory)
...
**Remember:** Personal TELOS files live at `${PAI_DIR}/PAI/USER/TELOS/` (in the CORE USER directory)
