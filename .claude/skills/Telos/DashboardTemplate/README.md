...
```bash
cp -r ${PAI_DIR}/skills/telos/dashboard-template /path/to/your/project
...
- Searches `${PAI_DIR}/skills/Telos/` for `.md` files
- Searches `${PAI_DIR}/skills/Telos/data/` for `.csv` files
