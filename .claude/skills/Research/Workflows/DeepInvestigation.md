...
```
${PAI_DIR}/MEMORY/RESEARCH/{YYYY-MM}/{YYYY-MM-DD}_{topic-slug}/
```

Read `${PAI_DIR}/MEMORY/STATE/current-work.json` for the active work directory.
...
Templates live at `${PAI_DIR}/skills/Research/Templates/{DomainName}.md`
