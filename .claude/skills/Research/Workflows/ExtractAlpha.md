...
```
${PAI_DIR}/MEMORY/WORK/20260111-172408_extract-alpha-analysis/
├── raw-transcript.txt
...
cd ${PAI_DIR}/MEMORY/WORK/${WORK_DIR}/
...
3. **Use work item directory** - Work in `${PAI_DIR}/MEMORY/WORK/{work_dir}/`
