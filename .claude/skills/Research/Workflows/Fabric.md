...
Patterns are managed by the Fabric skill at `${PAI_DIR}/skills/Fabric/`.
...
```bash
ls ${PAI_DIR}/skills/Fabric/Patterns/
```
...
**Full Pattern List:** `ls ${PAI_DIR}/skills/Fabric/Patterns/`
**Fabric Skill:** `${PAI_DIR}/skills/Fabric/SKILL.md`
**Fabric Documentation:** https://github.com/danielmiessler/fabric
**Pattern Templates:** See `${PAI_DIR}/skills/Fabric/Patterns/official_pattern_template/`
