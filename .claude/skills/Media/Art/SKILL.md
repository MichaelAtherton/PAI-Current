...
`${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/Art/`
...
**Load from:** `${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md`
...
Check `${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md` for:
...
bun run ${PAI_DIR}/skills/Media/Art/Tools/Generate.ts \
