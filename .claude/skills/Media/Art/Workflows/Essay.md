...
```bash
Read ${PAI_DIR}/skills/Media/Art/SKILL.md
```
...
bun ${PAI_DIR}/PAI/Tools/RemoveBg.ts /path/to/output.png

# Or batch process multiple images
bun ${PAI_DIR}/PAI/Tools/RemoveBg.ts image1.png image2.png image3.png
```

**See:** `${PAI_DIR}/skills/Images/Workflows/BackgroundRemoval.md` for full documentation.
...
3. EMOTION → Match to register in ${PAI_DIR}/PAI/aesthetic.md
