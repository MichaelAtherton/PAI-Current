...
async function loadEnv(): Promise<void> {
  const paiDir = (() => { const v = process.env.PAI_DIR; if (!v) throw new Error("PAI_DIR is required"); return v; })();
...
const PAI_DIR = (() => { const v = process.env.PAI_DIR; if (!v) throw new Error("PAI_DIR is required"); return v; })();
