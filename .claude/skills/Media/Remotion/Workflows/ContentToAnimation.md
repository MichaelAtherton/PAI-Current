...
# Load: ${PAI_DIR}/skills/Parser/Workflows/ExtractYoutube.md
```
...
```typescript
import { PAI_THEME } from '${PAI_DIR}/skills/Remotion/theme'
...
- Load: `${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md`
- Apply: Charcoal aesthetic, purple accents, organic animations
- Reference: `${PAI_DIR}/skills/Remotion/theme.ts`
