...
```
${PAI_DIR}/MEMORY/WORK/$(jq -r '.work_dir' ${PAI_DIR}/MEMORY/STATE/current-work.json)/YYYY-MM-DD-HHMMSS_due-diligence-[company]/
  phase1-domains.md
  phase2-technical.md
  phase3-research.md
  phase4-vetting.md
...
${PAI_DIR}/History/research/YYYY-MM/[company]-due-diligence/
