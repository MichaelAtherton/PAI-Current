...
`${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/WebAssessment/`
...
bun ${PAI_DIR}/skills/Security/Recon/Tools/CorporateStructure.ts target.com

# Subdomain enumeration
bun ${PAI_DIR}/skills/Security/Recon/Tools/SubdomainEnum.ts target.com

# Endpoint discovery from JavaScript
bun ${PAI_DIR}/skills/Security/Recon/Tools/EndpointDiscovery.ts https://target.com

# Port scanning
bun ${PAI_DIR}/skills/Security/Recon/Tools/PortScan.ts target.com

# Path discovery
bun ${PAI_DIR}/skills/Security/Recon/Tools/PathDiscovery.ts https://target.com
```
