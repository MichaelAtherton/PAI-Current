...
export const CONFIG = {
  ...
  // Local paths
  paths: {
    root: '${PAI_DIR}/skills/hacking/bug-bounties',
    state: '${PAI_DIR}/skills/hacking/bug-bounties/state.json',
    cache: '${PAI_DIR}/skills/hacking/bug-bounties/cache',
    logs: '${PAI_DIR}/skills/hacking/bug-bounties/logs',
  },
