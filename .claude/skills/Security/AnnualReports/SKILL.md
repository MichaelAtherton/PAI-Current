...
`${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/AnnualReports/`
...
bun run ${PAI_DIR}/skills/Security/AnnualReports/Tools/UpdateSources.ts

# List all sources
bun run ${PAI_DIR}/skills/Security/AnnualReports/Tools/ListSources.ts [category]

# Fetch a specific report
bun run ${PAI_DIR}/skills/Security/AnnualReports/Tools/FetchReport.ts <vendor> <report-name>
```
