...
**Save to:**
```
${PAI_DIR}/History/research/YYYY-MM-DD_[client]-recon/
...
```
${PAI_DIR}/History/research/YYYY-MM-DD_[client]-direct-injection/
├── findings.md
...
**Document findings in:**
```
${PAI_DIR}/History/research/YYYY-MM-DD_[client]-indirect-injection/
├── findings.md
├── poisoned-documents/
├── test-web-pages/
...
```
${PAI_DIR}/History/research/YYYY-MM-DD_[client]-multistage/
...
**Document in:**
```
${PAI_DIR}/History/research/YYYY-MM-DD_[client]-defenses/
...
**Deliverables:**
```
${PAI_DIR}/History/research/YYYY-MM-DD_[client]-final-report/
