...
`${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/Recon/`
...
- `naabu` - Port scanning
- Note: Requires security MCP profile (`${PAI_DIR}/MCPs/swap-mcp security`)
...
Reports saved to:
- **Work directory** (`${PAI_DIR}/MEMORY/WORK/{current_work}/`) - For iterative artifacts during investigation
...
${PAI_DIR}/MCPs/swap-mcp security
...
Assistant: Activating recon skill with passive-recon workflow.
     ...
     Report: ${PAI_DIR}/MEMORY/WORK/{current_work}/recon-example-com/
```
...
**Security Skills:**
- `${PAI_DIR}/skills/Investigation/` - Entity and people reconnaissance (OSINT)
- `${PAI_DIR}/skills/Security/WebAssessment/` - Web application testing
