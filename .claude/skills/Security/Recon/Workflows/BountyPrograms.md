...
bun ${PAI_DIR}/skills/Security/Recon/Tools/BountyPrograms.ts list

# Show only paid bounty programs (not just swag)
bun ${PAI_DIR}/skills/Security/Recon/Tools/BountyPrograms.ts list --bounty-only

# Search for programs by keyword
bun ${PAI_DIR}/skills/Security/Recon/Tools/BountyPrograms.ts search "crypto"
bun ${PAI_DIR}/skills/Security/Recon/Tools/BountyPrograms.ts search "finance"
bun ${PAI_DIR}/skills/Security/Recon/Tools/BountyPrograms.ts search "cloud"

# Check if a domain has a bounty program
bun ${PAI_DIR}/skills/Security/Recon/Tools/BountyPrograms.ts check example.com

# Update local cache from sources
bun ${PAI_DIR}/skills/Security/Recon/Tools/BountyPrograms.ts update

# Export as JSON
bun ${PAI_DIR}/skills/Security/Recon/Tools/BountyPrograms.ts list --json > bounty-programs.json
```
...
Local cache stored at: `${PAI_DIR}/skills/Security/Recon/Data/BountyPrograms.json`
