...
SCAN_FILE=${PAI_DIR}/MEMORY/WORK/${WORK_DIR}/$(date +%Y-%m-%d)_nmap-scan.txt

# Or masscan results
MASSCAN_FILE=${PAI_DIR}/MEMORY/WORK/${WORK_DIR}/$(date +%Y-%m-%d)_masscan.json

# Or combined multi-tool archive from history
SCAN_DIR=${PAI_DIR}/History/security/scans/2025-11-target-recon/
```
...
// Usage: bun run tools/batch-scan-analysis.ts ${PAI_DIR}/MEMORY/WORK/{current_work}/target-scans/
```
