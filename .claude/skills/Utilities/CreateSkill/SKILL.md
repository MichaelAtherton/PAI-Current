...
`${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/CreateSkill/`
...
**Before creating ANY skill, READ:** `${PAI_DIR}/PAI/SkillSystem.md`

**Canonical example to follow:** `${PAI_DIR}/skills/Research/SKILL.md`
...
**See:** `${PAI_DIR}/PAI/SkillSystem.md` (Flat Folder Structure section)
...
**See:** `${PAI_DIR}/PAI/SkillSystem.md` (Dynamic Loading Pattern section)
