...
1. Read the skill system documentation: `${PAI_DIR}/PAI/SkillSystem.md`
2. Read the canonical example: `${PAI_DIR}/skills/Research/SKILL.md`
...
**Example:**
```bash
mkdir -p ${PAI_DIR}/skills/YourSkill/Workflows
mkdir -p ${PAI_DIR}/skills/YourSkill/Tools
```
...
**Reference:** `${PAI_DIR}/PAI/CliFirstArchitecture.md` (Workflow-to-Tool Integration section)

**Examples (TitleCase):**
```bash
touch ${PAI_DIR}/skills/YourSkill/Workflows/UpdateDaemonInfo.md
touch ${PAI_DIR}/skills/YourSkill/Workflows/UpdatePublicRepo.md
touch ${PAI_DIR}/skills/YourSkill/Workflows/Create.md
touch ${PAI_DIR}/skills/YourSkill/Workflows/Publish.md
```
