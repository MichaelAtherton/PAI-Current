...
```bash
bun ${PAI_DIR}/skills/Utilities/AudioEditor/Tools/Pipeline.ts \
  "<audio-file-path>" \
...
```bash
# Transcription only
bun ${PAI_DIR}/skills/Utilities/AudioEditor/Tools/Transcribe.ts <file>

# Analysis only (requires transcript)
bun ${PAI_DIR}/skills/Utilities/AudioEditor/Tools/Analyze.ts <transcript.json>

# Edit only (requires audio + edits)
bun ${PAI_DIR}/skills/Utilities/AudioEditor/Tools/Edit.ts <file> <edits.json>

# Polish only (requires CLEANVOICE_API_KEY)
bun ${PAI_DIR}/skills/Utilities/AudioEditor/Tools/Polish.ts <file>
```
