...
`${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/Browser/`
...
**Headless by default.** All automation runs headless. When the user says "show me", open the URL in their preferred browser from `${PAI_DIR}/PAI/USER/TECHSTACKPREFERENCES.md`:
...
**Agent definitions:** `${PAI_DIR}/agents/BrowserAgent.md` and `${PAI_DIR}/agents/UIReviewer.md`
