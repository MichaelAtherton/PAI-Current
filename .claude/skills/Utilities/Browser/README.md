...
| `${PAI_DIR}/agents/BrowserAgent.md` | AI-driven browser agent definition |
| `${PAI_DIR}/agents/UIReviewer.md` | User story validation agent definition |

## Related

- [BrowserAgent](${PAI_DIR}/agents/BrowserAgent.md)
- [UIReviewer](${PAI_DIR}/agents/UIReviewer.md)
