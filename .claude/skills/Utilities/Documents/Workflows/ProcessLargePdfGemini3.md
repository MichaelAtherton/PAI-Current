...
import { insertNewsletterContent } from '${PAI_DIR}/skills/parser/db';
...
- For traditional PDF extraction (text-only), see `${PAI_DIR}/skills/documents/pdf/SKILL.md`
- For PDF form filling, see `${PAI_DIR}/skills/documents/pdf/forms.md`
- For parser integration, see `${PAI_DIR}/skills/parser/SKILL.md`
- For newsletter database schema, see `${PAI_DIR}/Context/databases/newsletter/schema.sql`
