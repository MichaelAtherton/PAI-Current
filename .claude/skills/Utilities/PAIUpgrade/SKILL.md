...
`${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/`
...
Read and analyze:
- ${PAI_DIR}/MEMORY/STATE/current-work.json
...
Analyze:
- ${PAI_DIR}/skills/ (installed skills)
- ${PAI_DIR}/hooks/ (active hooks)
- ${PAI_DIR}/settings.json (configuration)
...
Run: bun ${PAI_DIR}/skills/Utilities/PAIUpgrade/Tools/Anthropic.ts
...
**User Customizations** (`${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/`):
