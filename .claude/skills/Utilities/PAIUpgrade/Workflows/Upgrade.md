...
- ${PAI_DIR}/PAI/USER/TELOS/TELOS.md
- ${PAI_DIR}/PAI/USER/TELOS/GOALS.md
- ${PAI_DIR}/PAI/USER/TELOS/PROJECTS.md
- ${PAI_DIR}/PAI/USER/TELOS/CHALLENGES.md
- ${PAI_DIR}/PAI/USER/TELOS/STATUS.md
...
- Read ${PAI_DIR}/MEMORY/STATE/current-work.json
...
- List skills in ${PAI_DIR}/skills/
- List hooks in ${PAI_DIR}/hooks/
- Read ${PAI_DIR}/settings.json
...
1. Load channel config:
   bun ${PAI_DIR}/PAI/Tools/LoadSkillConfig.ts ../youtube-channels.json
...
4. For NEW videos, extract transcripts:
   bun ${PAI_DIR}/PAI/Tools/GetTranscript.ts '<video-url>'
...
1. Look in ${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/
...
1. Load the github_trending config from user-sources.json:
   Read ${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/user-sources.json
