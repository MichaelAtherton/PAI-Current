...
- **Built-in agents** (`${PAI_DIR}/agents/*.md`): Use this format for the persona section
- **Custom agents** (`${PAI_DIR}/custom-agents/*.md`): Use this format for the entire file
...
|--------|-------------------------|-------------------------------|
| Location | `${PAI_DIR}/agents/` | `${PAI_DIR}/custom-agents/` |
