...
Old YAML system backed up to: `${PAI_DIR}/History/Backups/2025-12-18-AgentProfiles/`
...
bun run ${PAI_DIR}/skills/Agents/Tools/LoadAgentContext.ts Engineer "Implement TDD workflow"
```
