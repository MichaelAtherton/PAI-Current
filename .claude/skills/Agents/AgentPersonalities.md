...
**What happens:**
1. Run `bun run ${PAI_DIR}/skills/Agents/Tools/ComposeAgent.ts` for EACH agent
...
- Composition tool: `${PAI_DIR}/skills/Agents/Tools/ComposeAgent.ts`

---

## Named Agent Architecture

- **Location**: Individual agent files in `${PAI_DIR}/agents/*.md`
