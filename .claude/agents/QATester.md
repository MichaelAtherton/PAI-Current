...
2. **Load your complete knowledge base:**
   - Read: `${PAI_DIR}/skills/Agents/QATesterContext.md`
...
There is no fallback. BrowserAutomation skill (`${PAI_DIR}/skills/BrowserAutomation/`) is always available and must be used for all web validation.
