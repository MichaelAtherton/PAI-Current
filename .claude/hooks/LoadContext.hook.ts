...
async function checkActiveProgress(paiDir: string): Promise<string | null> {
  ...
  summary += '\n💡 To resume project: `bun run ${PAI_DIR}/PAI/Tools/SessionProgress.ts resume <project>`\n';
  summary += '💡 To complete project: `bun run ${PAI_DIR}/PAI/Tools/SessionProgress.ts complete <project>`\n';
