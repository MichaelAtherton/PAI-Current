...
**All documentation files are in `${PAI_DIR}/PAI/` with USER/ subdirectory for personal overrides. Read these files when you need deeper context.**
...
**Agent System:**
- **Agents Skill** (`${PAI_DIR}/skills/Agents/`) - Complete agent composition system | See Agents skill for custom agent creation, traits, and voice mappings
