...
- Reference `${PAI_DIR}/PAI/USER/` for any personalization
...
- `${PAI_DIR}/PAI/USER/CONTACTS.md` - Contact information
- `${PAI_DIR}/PAI/USER/TECHSTACKPREFERENCES.md` - Tech preferences
```
...
`${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/{SkillName}/`
...
```
${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/
...
1. **Create directory**: `mkdir -p ${PAI_DIR}/PAI/USER/SKILLCUSTOMIZATIONS/SkillName`
...
**See:** `${PAI_DIR}/skills/Science/Protocol.md` for the full protocol interface
...
**Full documentation:** `${PAI_DIR}/PAI/THENOTIFICATIONSYSTEM.md`
...
Read ${PAI_DIR}/skills/Media/Art/Aesthetic.md
```
...
```
${PAI_DIR}/skills/Createskill/Workflows/CanonicalizeSkill.md
```
...
**Reference:** `${PAI_DIR}/skills/_PERSONAL/_MYSKILL/SKILL.md`
...
**See:** `${PAI_DIR}/PAI/CLIFIRSTARCHITECTURE.md` (Workflow-to-Tool Integration section)
...
**See:** `${PAI_DIR}/PAI/CLIFIRSTARCHITECTURE.md` (Configuration Flags section) for full documentation
