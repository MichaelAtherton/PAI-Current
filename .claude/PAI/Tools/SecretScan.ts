 ...
 *
 * Usage:
 *   bun ${PAI_DIR}/PAI/Tools/SecretScan.ts <directory>
 *   bun ${PAI_DIR}/PAI/Tools/SecretScan.ts . --verbose
 *   bun ${PAI_DIR}/PAI/Tools/SecretScan.ts . --verify
 *
 * @see ${PAI_DIR}/skills/_SYSTEM/Workflows/SecretScanning.md
 */
