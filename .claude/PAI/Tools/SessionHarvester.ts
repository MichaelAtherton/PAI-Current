 ...
 *
 * Harvests insights from ${PAI_DIR}/projects/ sessions and writes to LEARNING/
 *
 * Commands:
...
const CLAUDE_DIR = path.(() => { const v = process.env.PAI_DIR; if (!v) throw new Error("PAI_DIR is required"); return v; })();
// Derive the project slug dynamically from CLAUDE_DIR (works on macOS and Linux)
// macOS: ${PAI_DIR} → -Users-username--claude
