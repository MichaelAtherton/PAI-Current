 ...
 *   pai --local          Stay in current directory (don't cd to ${PAI_DIR})
...
const CLAUDE_DIR = (() => { const v = process.env.PAI_DIR; if (!v) throw new Error("PAI_DIR is required"); return v; })();
...
USAGE:
  ...
  k -l, --local            Stay in current directory (don't cd to ${PAI_DIR})
