 ...
 *
 * Usage:
 *   import { loadSkillConfig } from '${PAI_DIR}/PAI/Tools/LoadSkillConfig';
 *   const config = loadSkillConfig<MyConfigType>(__dirname, 'config.json');
 *
 * Or CLI:
 *   bun ${PAI_DIR}/PAI/Tools/LoadSkillConfig.ts <skill-dir> <filename>
 */
...
Examples:
  bun LoadSkillConfig.ts ${PAI_DIR}/skills/PAIUpgrade sources.json
