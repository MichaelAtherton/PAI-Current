 ...
 *
 * EXAMPLES:
 *   algorithm -m loop -p ${PAI_DIR}/MEMORY/WORK/auth/PRD-20260207-auth.md
...
const BASE_DIR = (() => { const v = process.env.PAI_DIR; if (!v) throw new Error("PAI_DIR is required"); return v; })();
...
PRD Resolution:
  Full path     ${PAI_DIR}/MEMORY/WORK/auth/PRD-20260207-auth.md
