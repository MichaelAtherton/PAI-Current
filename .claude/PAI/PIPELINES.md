...
Local pipeline definitions live in `${PAI_DIR}/PAI/PIPELINES/[Domain]_[Pipeline-Name]/PIPELINE.md`
...
```bash
mkdir -p ${PAI_DIR}/PAI/PIPELINES/[Domain]_[Pipeline-Name]
# PIPELINE-TEMPLATE.md is planned but not yet created
# For now, copy an existing pipeline and modify it
cp ${PAI_DIR}/PAI/PIPELINES/Blog_Publish-Post/PIPELINE.md ${PAI_DIR}/PAI/PIPELINES/[Domain]_[Pipeline-Name]/PIPELINE.md
```
...
- **Actions:** `${PAI_DIR}/PAI/ACTIONS.md`
- **Flows:** `${PAI_DIR}/PAI/FLOWS.md`
- **Architecture:** `${PAI_DIR}/PAI/PAISYSTEMARCHITECTURE.md`
- **Detailed README:** `${PAI_DIR}/PAI/PIPELINES/README.md`
