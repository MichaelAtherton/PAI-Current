...
bun run ${PAI_DIR}/skills/Agents/Tools/ComposeAgent.ts --traits "research,enthusiastic,exploratory"
bun run ${PAI_DIR}/skills/Agents/Tools/ComposeAgent.ts --traits "research,skeptical,systematic"
bun run ${PAI_DIR}/skills/Agents/Tools/ComposeAgent.ts --traits "research,analytical,synthesizing"
```
