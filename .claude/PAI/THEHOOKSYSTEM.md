...
- Writes to `${PAI_DIR}/MEMORY/SIGNALS/ratings.jsonl`
...
**Key Variables:**
- `PAI_DIR` - PAI installation directory (typically `${PAI_DIR}`)
...
**Full Documentation:** See `${PAI_DIR}/PAI/TERMINALTABS.md`
...
2. Does current-work file exist? Check `${PAI_DIR}/MEMORY/STATE/current-work.json`
...
grep '"type":"user"' ${PAI_DIR}/projects/-Users-username--claude/*.jsonl | head -1 | jq '.type'
...
**Check:**
1. Does `${PAI_DIR}/PAI/SKILL.md` exist?
...
bun ${PAI_DIR}/hooks/LoadContext.hook.ts
...
- Permission denied → `chmod +x ${PAI_DIR}/hooks/LoadContext.hook.ts`
...
- **Voice System:** `${PAI_DIR}/VoiceServer/SKILL.md`
- **Agent System:** `${PAI_DIR}/skills/Agents/SKILL.md`
- **History/Memory:** `${PAI_DIR}/PAI/MEMORYSYSTEM.md`
...
${PAI_DIR}/hooks/                     Hook scripts (22 files)
${PAI_DIR}/hooks/handlers/            Handler modules (6 files)
${PAI_DIR}/hooks/lib/                 Shared libraries (13 files)
${PAI_DIR}/hooks/lib/learning-utils.ts Learning categorization
${PAI_DIR}/hooks/lib/time.ts          PST timestamp utilities
${PAI_DIR}/hooks/lib/event-types.ts   Typed event definitions (22 interfaces)
${PAI_DIR}/hooks/lib/event-emitter.ts appendEvent() → events.jsonl
...
Path: ${PAI_DIR}/PAI/Tools/Inference.ts
