...
**Primary Skill:** `${PAI_DIR}/skills/Fabric/SKILL.md`
...
**Patterns Location:** `${PAI_DIR}/skills/Fabric/Patterns/` (237 patterns)
...
-> Runs fabric -U
-> Syncs to ${PAI_DIR}/skills/Fabric/Patterns/
```

**Manual:**
```bash
fabric -U && rsync -av ~/.config/fabric/patterns/ ${PAI_DIR}/skills/Fabric/Patterns/
```
...
- **Full Skill:** `${PAI_DIR}/skills/Fabric/SKILL.md`
- **Pattern Execution:** `${PAI_DIR}/skills/Fabric/Workflows/ExecutePattern.md`
- **Pattern Updates:** `${PAI_DIR}/skills/Fabric/Workflows/UpdatePatterns.md`
- **All Patterns:** `${PAI_DIR}/skills/Fabric/Patterns/`
