...
**Full voice registry:** `${PAI_DIR}/skills/Agents/SKILL.md` (see Named Agents) and `${PAI_DIR}/settings.json` (daidentity.voiceId)
...
The notification service is in `${PAI_DIR}/hooks/lib/notifications.ts`:
