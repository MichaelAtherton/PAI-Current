...
Local flow definitions are tracked in `${PAI_DIR}/PAI/FLOWS/flow-index.json`:
...
Flow state (run history, errors) is tracked in `${PAI_DIR}/MEMORY/STATE/flow-state.json`.
...
- **Actions:** `${PAI_DIR}/PAI/ACTIONS.md` *(planned)*
- **Pipelines:** `${PAI_DIR}/PAI/PIPELINES.md`
- **Architecture:** `${PAI_DIR}/PAI/PAISYSTEMARCHITECTURE.md`
- **Detailed README:** `${PAI_DIR}/PAI/FLOWS/README.md`
